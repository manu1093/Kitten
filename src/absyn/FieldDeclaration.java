...
public class FieldDeclaration extends ClassMemberDeclaration {
	...
	protected void typeCheckAux(ClassType currentClass) {
		...
		if(name.equals("iTime")||name.equals("testname")||name.equals("tTime")||name.equals("tRes")||name.equals("tName"))
			error(checker,"il nome "+name+" non puo\' essere utilizzato per un campo");
	}
