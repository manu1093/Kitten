...
public final class ClassType extends ReferenceType {
	...
	private final Map<String, TestSignature> tests=new HashMap<>();//i test non hanno il polimorfismo
	
	private final ArrayList<FixtureSignature> fixtures=new ArrayList<>(); 
	/**
...
public void addTest(String name,TestSignature tSig){//aggunto da me
...
public void addFixture(FixtureSignature fsig) {
	this.fixtures.add(fsig);	
}
public ArrayList<FixtureSignature> getFixtures(){
