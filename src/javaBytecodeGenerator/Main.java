...
public class Main {
	public static void main(String[] args) {
		...
		clazz.setStartClass();
		//ClassType clazz = ClassType.mkFromFileName(System.getProperty("user.dir")+"/testcases/Miao.kit");
		//System.out.println(System.getProperty("user.dir")+"/testcases/Digit.kit");
		ErrorMsg errorMsg = clazz.getErrorMsg();
		//System.out.println(errorMsg.getLines().toString());
